...
class MITCampus(Campus):
    ...
    def __init__(self, center_loc, tent_loc = Location(0,0)):
        ...
        Initializes a new Campus centered at location center_loc
        with a tent at location tent_loc """
        self.location = Campus.__init__(self, center_loc)
        self.tent_locations = [tent_loc]
    ...
    def add_tent(self, new_tent_loc):
        ...
        away from all other tents already there. Campus is unchanged otherwise.
        Returns True if it could add the tent, False otherwise. """
        for tent_loc in self.tent_locations:
            if new_tent_loc.dist_from(tent_loc) < 0.5:
                return False
    ...
    def get_tents(self):
        ...
        tent_loc_list = []
        for tent_loc in self.tent_locations:
            tent_loc_list.append(str(tent_loc))
        return sorted(tent_loc_list)
